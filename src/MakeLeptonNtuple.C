...
int main(int argc, char* argv[]) {
  ...
  if ( argc < 2 ){
    ...
    cout << "  Example:      ./MakeLeptonNtuple.x -ifile=input.root -ofile=output.root -dataset=dataset_name -filetag=sample_tag"  << endl;
    cout << "  Example:      ./MakeLeptonNtuple.x -ilist=input.list -ofile=output.root -dataset=dataset_name -filetag=sample_tag"  << endl;
    cout << "  Example:      ./MakeLeptonNtuple.x -ifold=folder_path -ofile=output.root -dataset=dataset_name -filetag=sample_tag -tree=treename -eventcount=event_count --sms" << endl;
  ...
  LeptonNtuple* ntuple = new LeptonNtuple(chain);
